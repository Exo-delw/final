export const SITE_CONFIG = {
  name: "Stenar Trading PLC",
  description:
    "Your trusted partner in international trade and business solutions.",
  contactEmail: "info@stenartrading.com",
...
export const Values = [
  {
    icon: "/icons/excellence-svgrepo-com-1.svg",
    title: "Client Centric Excellence",
    description:
      "We design and deliver solutions tailored to our clients’ objectives, ensuring measurable impact and long term value.",
  },
  {
    icon: "/icons/application-effect-svgrepo-com-1.svg",
    title: "Integrity & Confidentiality",
    description:
      "We operate with the highest standards of professional ethics, accountability, and data confidentiality.",
  },
  {
    icon: "/icons/idea-svgrepo-com--1--1.svg",
    title: "Innovation & Reliability",
    description:
      "We combine innovative thinking with dependable execution to deliver practical, scalable, and future ready solutions.",
  },
];

export const Services = [
  {
    icon: "/images/service_img_1.png",
    title: "OutSourcing",
    slug: "outsourcing",
    description:
      "Comprehensive business process outsourcing including HR management, payroll, Tax Reporting, sales and marketing workforce, IT support, and project outsourcing.",
  },
  {
